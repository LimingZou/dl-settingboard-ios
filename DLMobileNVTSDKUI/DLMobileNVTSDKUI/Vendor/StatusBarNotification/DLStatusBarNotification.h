 ...
 * @c DLNotificationStyleStatusBarNotification.
 */
@property (nonatomic) DLNotificationStyle notificationStyle;
/**
 * Determines the direction from which the notification animates in. Default
 * value is @c DLNotificationAnimationStyleBottom.
 */
@property (nonatomic) DLNotificationAnimationStyle notificationAnimationInStyle;
/**
 * Determines the direction from which the notification animates out. Default
 * value is @c DLNotificationAnimationStyleBottom.
 */
@property (nonatomic) DLNotificationAnimationStyle
 ...
 * @c DLNotificationAnimationTypeReplace.
 */
@property (nonatomic) DLNotificationAnimationType notificationAnimationType;
/**
