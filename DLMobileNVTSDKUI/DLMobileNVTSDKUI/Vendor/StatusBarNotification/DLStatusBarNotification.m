...
@interface DLStatusBarNotification()
...
@implementation DLStatusBarNotification
...
- (DLStatusBarNotification *)init
{
    ...
    if (self) {
        ...
        self.notificationStyle = DLNotificationStyleStatusBarNotification;
        self.notificationAnimationInStyle = DLNotificationAnimationStyleBottom;
        self.notificationAnimationOutStyle = DLNotificationAnimationStyleBottom;
        self.notificationAnimationType = DLNotificationAnimationTypeReplace;
...
- (CGFloat)getNotificationLabelHeight
{
    switch (self.notificationStyle) {
        case DLNotificationStyleStatusBarNotification:
            return [self getStatusBarHeight];
        case DLNotificationStyleNavigationBarNotification:
...
- (void)setupNotificationView:(UIView *)view
{
    ...
    switch (self.notificationAnimationInStyle) {
        case DLNotificationAnimationStyleTop:
            view.frame = [self getNotificationLabelTopFrame];
            break;
        case DLNotificationAnimationStyleBottom:
            view.frame = [self getNotificationLabelBottomFrame];
            break;
        case DLNotificationAnimationStyleLeft:
            view.frame = [self getNotificationLabelLeftFrame];
            break;
        case DLNotificationAnimationStyleRight:
...
- (void)createStatusBarView
{
    ...
    if (self.notificationAnimationType == DLNotificationAnimationTypeReplace) {
